...
const indexOfGiraffe = animalStrings.findIndex((animalString) => animalString.includes("giraffe"));
...
const sumOfAllAnimalCharacters = animalStrings.reduce((sum, animalString) => sum + animalString.length, 0);
